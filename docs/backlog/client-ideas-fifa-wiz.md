...
> **Status:** Prioritized → see [fifa-wiz/](./fifa-wiz/README.md)
...
→ [P0-05](./fifa-wiz/P0-05-context-aware-object-translation.md) (partial: P3-12 shipped)
...
→ [P0-07](./fifa-wiz/P0-07-consistency-check.md) — EverRest: glossary + drift, not standalone AI

## 5. Confluence Import (must have)
→ [P0-03](./fifa-wiz/P0-03-confluence-import.md) — EverRest: killer feature

## 6. Translation Coverage Heatmap
→ [P0-06](./fifa-wiz/P0-06-translation-coverage-heatmap.md)

## 8. New Keys Alert
→ [P0-11](./fifa-wiz/P0-11-new-keys-alert.md) — conditional

## 9. Sport-Domain AI Context (must have)
→ [P0-01](./fifa-wiz/P0-01-sport-domain-ai-context.md) — EverRest: easy win

## 10. Excel Round-Trip Compatibility (must have)
→ [P0-02](./fifa-wiz/P0-02-excel-delta-import.md)

## 11. Placeholder Protection (must have)
→ [P0-S02](./fifa-wiz/P0-S02-placeholder-protection.md) — shipped

## 12. Stale Translation Detection (must have)
→ [P0-04](./fifa-wiz/P0-04-stale-translation-detection.md)

## 13. Translation Inheritance Between Events
→ [P0-08](./fifa-wiz/P0-08-translation-inheritance.md)

## 14. Glossary / Translation Memory (must have)
→ [P0-S01](./fifa-wiz/P0-S01-glossary-platform.md) — shipped

## 15–16, 19–22, 24–27, 29
See [fifa-wiz/README.md](./fifa-wiz/README.md) deferred and shipped sections.
