...
| [P0-03](./P0-03-documentation-import) | Confluence import | Critical | Medium–High | #5 | **Shipped** — file import + OAuth live sync |
...
Wave 2 (client onboarding, 2–4 weeks)
  ~~P0-03 Confluence file import (phase 1)~~ — **shipped**
  ~~P0-03 Confluence live API (OAuth)~~ — **shipped**
...
| P0-01 Sport context | [P2-04](../P2-04-brand-voice.md) + project domain field |
